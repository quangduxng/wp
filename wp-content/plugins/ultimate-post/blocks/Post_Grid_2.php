...
class Post_Grid_2{
    ...
    public function get_attributes() {
        ...
        return array(
            ...
            'overlayHeight' =>  (object)['lg' =>'250', 'unit' =>'px'],
            'titleShow' =>  true,
            'titleStyle' =>  'none',
            ...
            'catTypo' =>  (object)['openTypography' => 1, 'size' => (object)['lg' =>11, 'unit' =>'px'], 'height' => (object)['lg' =>15, 'unit' =>'px'], 'spacing' => (object)['lg' =>1, 'unit' =>'px'], 'transform' => '', 'weight' => '400', 'decoration' => 'none','family'=>'' ],
            'catColor' =>  '#fff',
            ...
            'readMoreBgHoverColor' =>  (object)['openColor' => 0, 'type' => 'color', 'color' => '#037fff'],
